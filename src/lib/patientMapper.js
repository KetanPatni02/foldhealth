...
export function dbToJs(row) {
  return {
    ...
    aiOutcomeInitiated: row.ai_outcome_initiated ?? true,
    aiOutcomeStatus: row.ai_outcome_status || null,
    aiOutcomeInvokedAt: row.ai_outcome_invoked_at || null,
    dob: row.dob || null,
...
export function jsToDb(patient) {
  ...
  const map = {
    ...
    aiOutcomeInitiated: 'ai_outcome_initiated',
    aiOutcomeStatus: 'ai_outcome_status',
    aiOutcomeInvokedAt: 'ai_outcome_invoked_at',
    dob: 'dob',
    email: 'email',
    phone: 'phone',
    city: 'city',
