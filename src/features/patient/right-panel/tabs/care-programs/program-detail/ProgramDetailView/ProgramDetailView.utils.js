...
export const ASSESSMENT_STEPS = {
  ...
  'Post IP Assessment': { formName: 'Post IP Assessment form', title: 'Post IP Assessment', filledBy: 'Annette Brave', filledDate: '10/11/24', reviewedBy: 'Robert Fox', reviewedDate: '10/11/24' },
