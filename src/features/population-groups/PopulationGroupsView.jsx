...
function PopulationGroupsView({ activeFilter, onToggleSidebar, onMiniBarOpen, miniBarExpandRef, miniBarCloseRef, onModalClose, onBackdropChange, onGroupCreated, onUploadError, onMemberAdded }) {
  ...
  /* Header / cell styling — identical to the TOC Worklist table (WorklistTable.jsx) */
  const thStyle = {
  ...
  const tdStyle = { padding: '8px 14px', fontSize: 14, fontWeight: 400, color: 'var(--neutral-300)', verticalAlign: 'middle' };
            ...
            {pagedGroups.map((g, idx) => {
              ...
              return (
                <tr key={g.id}
                  ...
                  style={{ borderBottom:'1px solid var(--neutral-150)', background: isHov ? 'var(--primary-25)' : 'var(--neutral-0)', transition:'background 0.1s', cursor:'pointer' }}>
                  ...
                  <td style={{ ...tdStyle, padding:'8px 12px' }}>
                    <div style={{ display:'flex', alignItems:'center', gap:12 }}>
                      ...
                      <span style={{ fontSize:14, fontWeight:500, color:'var(--neutral-400)', lineHeight:1.4 }}>{g.name}</span>
                    </div>
                  </td>
