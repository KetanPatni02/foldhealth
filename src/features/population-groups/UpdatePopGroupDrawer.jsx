...
function Label({ children, required }) {
  return (
    <label style={{ display:'block', fontSize: 'var(--font-base)', fontWeight:400, color:'var(--neutral-200)', marginBottom: 6 }}>
...
function StaticSelect({ value, disabled }) {
  return (
    <div style={{
      ...
      fontSize: 'var(--font-base)', fontFamily:'Inter, sans-serif', cursor:'not-allowed',
    }}>
...
const CHIP_STYLE = { display:'inline-flex', alignItems:'center', gap:6, height:24, padding:'0 6px 0 8px', background:'var(--neutral-50)', border:'0.5px solid var(--neutral-150)', borderRadius:6, fontSize: 'var(--font-md)', color:'var(--neutral-300)', whiteSpace:'nowrap', flexShrink: 0, boxSizing:'border-box' };
  ...
  return (
    ...
    >
      ...
      <input
        ...
        style={{ flex:1, minWidth:40, border:'none', outline:'none', background:'transparent', fontSize: 'var(--font-base)', fontFamily:'Inter, sans-serif', color:'var(--neutral-400)' }}
      />
  ...
  return (
    ...
    >
      <div className="thin-scroll" style={{ flex:1, overflowY:'auto', padding:16, display:'flex', flexDirection:'column', gap:16, fontFamily:'Inter, sans-serif' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:8 }}>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:8, flex:'1 0 0', minWidth:0 }}>
            ...
            <div style={{ flex:'1 0 0', minWidth:0 }}>
              ...
              <div style={{ fontSize: 'var(--font-base)', fontWeight:400, color:'var(--neutral-200)', lineHeight:1.2, marginTop: 2 }}>{fileCount} patients added</div>
            </div>
          </div>
        ...
        <div ref={patRef} style={{ position:'relative' }}>
          ...
          {patOpen && (
            <div className="thin-scroll" style={{ position:'absolute', top:'calc(100% + 4px)', left:0, right:0, zIndex:2300, maxHeight:280, overflowY:'auto', background:'var(--neutral-0)', border:'0.5px solid var(--neutral-150)', borderRadius:8, boxShadow:'0 4px 16px rgba(0,0,0,0.10)', padding:4 }}>
              {options.length === 0 ? (
                <div style={{ padding:'10px', fontSize: 'var(--font-md)', color:'var(--neutral-200)' }}>No patients found</div>
              ) : options.map(p => {
        ...
        <div>
          <div style={{ fontSize: 'var(--font-base)', fontWeight:500, color:'var(--neutral-400)', marginBottom: 6 }}>Below automation(s) will execute for this population group</div>
          <div style={{ height:36, padding:'0 10px', boxSizing:'border-box', display:'flex', alignItems:'center', gap:4, border:'0.5px solid var(--neutral-200)', borderRadius:6, background:'var(--neutral-0)' }}>
            ...
            <span style={{ flex:1, color:'var(--neutral-200)', fontSize: 'var(--font-base)' }}>Search Automation</span>
            <Icon name="solar:alt-arrow-down-linear" size={14} color="var(--neutral-200)" />
          </div>
        </div>
      </div>
