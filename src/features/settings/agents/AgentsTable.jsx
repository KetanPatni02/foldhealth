...
import { EscalationPolicyPanel } from './EscalationPolicyPanel';
import { KnowledgeBasePanel } from './knowledge-base/KnowledgeBasePanel';
import { GoalsPanel } from './goals/GoalsPanel';
import { AuditLogDrawer } from '../shared/AuditLogDrawer';
...
export function AgentsTable() {
  ...
  // Only the visible tab fetches, and only until the first successful load —
  // switching to Goals/Knowledge Base (or revisiting the tab) must not
  // re-query `agents`.
