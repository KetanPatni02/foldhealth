...
export const ACTIVITY = {
  "Annette Brave": [
    ...
    { t:"status_dos",  date:"01/26/2026", time:"12:30 PM", by:"Benjamin Cummings", role:"Reviewer",  dos:"03/04/2025", icds:["E11.22","E11.21","E44.0","E11.51"], headline:"DOS 03/04/2025 Status Changed", from:"Open", to:"Returned" },
    ...
    { t:"create",      date:"01/11/2026", time:"12:30 PM", by:"Benjamin Cummings", role:"Reviewer",  dos:"03/04/2025", icds:["E11.51"], headline:"ICD: E11.51 Created Manually" },
    { t:"assign_coder",date:"01/10/2026", time:"12:30 PM", by:"Benjamin Cummings", role:"Reviewer",  dos:"03/04/2025", icds:["E11.22","E11.21","E44.0","E11.51"], headline:"Coder Changed", fromAvatar:{initials:"AR",name:"Dr. Aldo Richman"}, toAvatar:{initials:"BC",name:"Benjamin Cummings"} },
  ],
  "Frank Green": [
    { t:"group", label:"Jan 2026" },
    { t:"status_dos",  date:"01/26/2026", time:"10:00 AM", by:"L. Schmidt",    role:"Reviewer",  dos:"09/28/2023", icds:["I50.9","E11.9","J44.1"],  headline:"DOS 09/28/2023 Status Changed to Completed", from:"In Progress", to:"Completed" },
    { t:"accept",      date:"01/15/2026", time:"09:00 AM", by:"L. Schmidt",    role:"Reviewer",  dos:"09/28/2023", icds:["I50.9"],                   headline:"ICD: I50.9 Status Changed to Accept",
    ...
    { t:"assign_coder",date:"01/08/2026", time:"09:00 AM", by:"L. Schmidt",    role:"Reviewer",  dos:"09/28/2023", icds:["I50.9","E11.9","J44.1"],  headline:"Coder Changed", fromAvatar:{initials:"DH",name:"D. Hintz"}, toAvatar:{initials:"JL",name:"J. Levesque"} },
  ],
  "Brian Carter": [
    { t:"group", label:"Nov 2023" },
    { t:"accept",      date:"11/29/2023", time:"02:00 PM", by:"M. Almeda",     role:"Reviewer",  dos:"11/29/2023", icds:["F32.1","E11.65"],          headline:"2 ICD: F32.1, E11.65 Status Changed to Accept",
      details:[
    ...
    { t:"assign_coder",date:"11/10/2023", time:"09:00 AM", by:"M. Almeda",     role:"Reviewer",  dos:"11/29/2023", icds:["F32.1","E11.65","I48.91","M79.3"], headline:"Coder Changed", fromAvatar:{initials:"AR",name:"A. Reed"}, toAvatar:{initials:"DH",name:"D. Hintz"} },
  ],
  "_default": [
    { t:"group", label:"Jan 2026" },
    ...
    { t:"accept",      date:"01/24/2026", time:"12:30 PM", by:"N. Richards",     role:"Reviewer",  dos:"07/04/2024", icds:["E11.21","I48.91"],         headline:"2 ICD: E11.21, I48.91 Status Changed to Accept",
      details:[
    ...
    { t:"create",      date:"01/11/2026", time:"12:30 PM", by:"Benjamin Cummings",role:"Reviewer", dos:"07/04/2024", icds:["I48.91"],                  headline:"ICD: I48.91 Created Manually" },
